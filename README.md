...
知识来源页与任务中心提供 NoteSync 状态、固定映射、三方预览和原审阅入口。预览不发布，
采用/合并复用知识身份与影响审阅，未知结果核对原操作；研究集合不会继承默认映射。
使用步骤及权限边界见 [学习端来源同步](clients/web/README.md#notesync-来源同步)，
本次检查范围见 [Issue #35 验收记录](docs/development/issue-35-acceptance.md)。
