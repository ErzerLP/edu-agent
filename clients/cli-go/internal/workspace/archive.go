...
func (r *Reference) IsOperation() bool {
	return r != nil && (r.IsArchive() || r.Kind == "mkdir" || r.Kind == "copy" || r.Kind == "move_file" || r.Kind == "move_directory" || r.Kind == "restore_file" || r.Kind == "restore_directory" || r.Kind == "purge_file" || r.Kind == "purge_directory" || r.Kind == "purge_link" || r.Kind == "file_effect")
}
